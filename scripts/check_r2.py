...
def main():
    ...
    try:
        ...
        return 1
    except Exception:  # noqa: BLE001 - redact unexpected SDK diagnostics at CLI boundary
        print(
            "R2 connection failed. Check network and local configuration; details hidden to protect credentials."
        )
        return 1
